...
export const txClient = (
  ...
  return {
    ...
    async sendMsgAuthorizeCircuitBreakerResponse({
      value,
      fee,
      memo,
    }: sendMsgAuthorizeCircuitBreakerResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
      ...
      try {
        const { address } = (await signer.getAccounts())[0];
        const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry });
        let msg = this.msgAuthorizeCircuitBreakerResponse({
          value: MsgAuthorizeCircuitBreakerResponse.fromPartial(value),
        });
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
      } catch (e: any) {
    ...
    async sendMsgResetCircuitBreaker({
      value,
      fee,
      memo,
    }: sendMsgResetCircuitBreakerParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendGenesisAccountPermissions({
      value,
      fee,
      memo,
    }: sendGenesisAccountPermissionsParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryDisabledListRequest({
      value,
      fee,
      memo,
    }: sendQueryDisabledListRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgAuthorizeCircuitBreaker({
      value,
      fee,
      memo,
    }: sendMsgAuthorizeCircuitBreakerParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgTripCircuitBreakerResponse({
      value,
      fee,
      memo,
    }: sendMsgTripCircuitBreakerResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgResetCircuitBreakerResponse({
      value,
      fee,
      memo,
    }: sendMsgResetCircuitBreakerResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    genesisAccountPermissions({ value }: genesisAccountPermissionsParams): EncodeObject {
      try {
        return {
          ...
          value: GenesisAccountPermissions.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryDisabledListRequest({ value }: queryDisabledListRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryDisabledListRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    msgTripCircuitBreakerResponse({ value }: msgTripCircuitBreakerResponseParams): EncodeObject {
      try {
        return {
          ...
          value: MsgTripCircuitBreakerResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    msgResetCircuitBreakerResponse({ value }: msgResetCircuitBreakerResponseParams): EncodeObject {
      try {
        return {
          ...
          value: MsgResetCircuitBreakerResponse.fromPartial(value),
        };
      } catch (e: any) {

...
function createBaseConditionalencPacketData(): ConditionalencPacketData {
...
export const ConditionalencPacketData = {
  ...
  fromJSON(object: any): ConditionalencPacketData {
    return {
  ...
  toJSON(message: ConditionalencPacketData): unknown {
    const obj: any = {};
    if (message.noData !== undefined) {

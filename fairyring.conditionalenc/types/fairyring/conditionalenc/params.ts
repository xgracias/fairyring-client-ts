...
export interface Params {
  ...
  slashFractionNoConditionalenc: Uint8Array;
  slashFractionWrongConditionalenc: Uint8Array;
...
function createBaseParams(): Params {
  return {
    keyExpiry: 0,
    trustedAddresses: [],
    slashFractionNoConditionalenc: new Uint8Array(),
    slashFractionWrongConditionalenc: new Uint8Array(),
    minimumBonded: 0,
    maxIdledBlock: 0,
  };
}
...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.slashFractionNoConditionalenc.length !== 0) {
      writer.uint32(26).bytes(message.slashFractionNoConditionalenc);
    }
    if (message.slashFractionWrongConditionalenc.length !== 0) {
      writer.uint32(34).bytes(message.slashFractionWrongConditionalenc);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.slashFractionNoConditionalenc = reader.bytes();
          break;
        case 4:
          message.slashFractionWrongConditionalenc = reader.bytes();
          break;
        case 5:
  ...
  fromJSON(object: any): Params {
    return {
      ...
      trustedAddresses: Array.isArray(object?.trustedAddresses)
        ...
        : [],
      slashFractionNoConditionalenc: isSet(object.slashFractionNoConditionalenc)
        ? bytesFromBase64(object.slashFractionNoConditionalenc)
        : new Uint8Array(),
      slashFractionWrongConditionalenc: isSet(object.slashFractionWrongConditionalenc)
        ? bytesFromBase64(object.slashFractionWrongConditionalenc)
        : new Uint8Array(),
  ...
  toJSON(message: Params): unknown {
    ...
    message.slashFractionNoConditionalenc !== undefined
      && (obj.slashFractionNoConditionalenc = base64FromBytes(
        message.slashFractionNoConditionalenc !== undefined ? message.slashFractionNoConditionalenc : new Uint8Array(),
      ));
    message.slashFractionWrongConditionalenc !== undefined
      && (obj.slashFractionWrongConditionalenc = base64FromBytes(
        message.slashFractionWrongConditionalenc !== undefined ? message.slashFractionWrongConditionalenc : new Uint8Array(),
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.slashFractionNoConditionalenc = object.slashFractionNoConditionalenc ?? new Uint8Array();
    message.slashFractionWrongConditionalenc = object.slashFractionWrongConditionalenc ?? new Uint8Array();

...
export { MsgRegisterValidator, MsgSendKeyshare, MsgCreateLatestPubKey };
...
export const txClient = (
  ...
  return {
    ...
    msgRegisterValidator({ value }: msgRegisterValidatorParams): EncodeObject {
      try {
        return {
          typeUrl: '/fairyring.keyshare.MsgRegisterValidator',
          value: MsgRegisterValidator.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
    ...
    msgSendKeyshare({ value }: msgSendKeyshareParams): EncodeObject {
      try {
        return {
          typeUrl: '/fairyring.keyshare.MsgSendKeyshare',
          value: MsgSendKeyshare.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(

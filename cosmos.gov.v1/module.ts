...
import { DecryptedVoteOption as typeDecryptedVoteOption} from "./types"
import { TrustedCounterParty as typeTrustedCounterParty} from "./types"

export { MsgVoteEncrypted, MsgVoteWeighted, MsgUpdateParams, MsgDeposit, MsgVote, MsgSubmitProposal };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						DecryptedVoteOption: getStructure(typeDecryptedVoteOption.fromPartial({})),

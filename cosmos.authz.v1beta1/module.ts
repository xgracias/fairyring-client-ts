...
export const txClient = (
  ...
  return {
    ...
    async sendQueryGranterGrantsResponse({
      value,
      fee,
      memo,
    }: sendQueryGranterGrantsResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryGranteeGrantsResponse({
      value,
      fee,
      memo,
    }: sendQueryGranteeGrantsResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryGranterGrantsRequest({
      value,
      fee,
      memo,
    }: sendQueryGranterGrantsRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryGranteeGrantsRequest({
      value,
      fee,
      memo,
    }: sendQueryGranteeGrantsRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    queryGranterGrantsResponse({ value }: queryGranterGrantsResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryGranterGrantsResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryGranteeGrantsResponse({ value }: queryGranteeGrantsResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryGranteeGrantsResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    genericAuthorization({ value }: genericAuthorizationParams): EncodeObject {
      try {
        return {
          ...
          value: GenericAuthorization.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryGranterGrantsRequest({ value }: queryGranterGrantsRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryGranterGrantsRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryGranteeGrantsRequest({ value }: queryGranteeGrantsRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryGranteeGrantsRequest.fromPartial(value),
        };
      } catch (e: any) {

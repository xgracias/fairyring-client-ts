...
export const txClient = (
  ...
  return {
    async sendMsgRegisterInterchainAccountResponse({
      value,
      fee,
      memo,
    }: sendMsgRegisterInterchainAccountResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
      ...
      try {
        ...
        let msg = this.msgRegisterInterchainAccountResponse({
          value: MsgRegisterInterchainAccountResponse.fromPartial(value),
        });
    ...
    async sendQueryInterchainAccountRequest({
      value,
      fee,
      memo,
    }: sendQueryInterchainAccountRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryInterchainAccountResponse({
      value,
      fee,
      memo,
    }: sendQueryInterchainAccountResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgRegisterInterchainAccount({
      value,
      fee,
      memo,
    }: sendMsgRegisterInterchainAccountParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    queryInterchainAccountRequest({ value }: queryInterchainAccountRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryInterchainAccountRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryInterchainAccountResponse({ value }: queryInterchainAccountResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryInterchainAccountResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    msgSendTxResponse({ value }: msgSendTxResponseParams): EncodeObject {
      try {
        return {
          ...
          value: MsgSendTxResponse.fromPartial(value),
        };
      } catch (e: any) {

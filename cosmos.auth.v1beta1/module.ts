...
export const txClient = (
  ...
  return {
    async sendAddressBytesToStringResponse({
      value,
      fee,
      memo,
    }: sendAddressBytesToStringResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendAddressStringToBytesRequest({
      value,
      fee,
      memo,
    }: sendAddressStringToBytesRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAccountInfoResponse({
      value,
      fee,
      memo,
    }: sendQueryAccountInfoResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryModuleAccountsResponse({
      value,
      fee,
      memo,
    }: sendQueryModuleAccountsResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendAddressStringToBytesResponse({
      value,
      fee,
      memo,
    }: sendAddressStringToBytesResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAccountInfoRequest({
      value,
      fee,
      memo,
    }: sendQueryAccountInfoRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAccountAddressByIDRequest({
      value,
      fee,
      memo,
    }: sendQueryAccountAddressByIDRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryModuleAccountByNameResponse({
      value,
      fee,
      memo,
    }: sendQueryModuleAccountByNameResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAccountAddressByIDResponse({
      value,
      fee,
      memo,
    }: sendQueryAccountAddressByIDResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryModuleAccountsRequest({
      value,
      fee,
      memo,
    }: sendQueryModuleAccountsRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryModuleAccountByNameRequest({
      value,
      fee,
      memo,
    }: sendQueryModuleAccountByNameRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendAddressBytesToStringRequest({
      value,
      fee,
      memo,
    }: sendAddressBytesToStringRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    addressBytesToStringResponse({ value }: addressBytesToStringResponseParams): EncodeObject {
      try {
        return {
          ...
          value: AddressBytesToStringResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    addressStringToBytesRequest({ value }: addressStringToBytesRequestParams): EncodeObject {
      try {
        return {
          ...
          value: AddressStringToBytesRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAccountInfoResponse({ value }: queryAccountInfoResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAccountInfoResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryModuleAccountsResponse({ value }: queryModuleAccountsResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryModuleAccountsResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    addressStringToBytesResponse({ value }: addressStringToBytesResponseParams): EncodeObject {
      try {
        return {
          ...
          value: AddressStringToBytesResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAccountInfoRequest({ value }: queryAccountInfoRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAccountInfoRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAccountAddressByIdrequest({ value }: queryAccountAddressByIdrequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAccountAddressByIDRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAccountsResponse({ value }: queryAccountsResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAccountsResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryModuleAccountByNameResponse({ value }: queryModuleAccountByNameResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryModuleAccountByNameResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAccountAddressByIdresponse({ value }: queryAccountAddressByIdresponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAccountAddressByIDResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryModuleAccountsRequest({ value }: queryModuleAccountsRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryModuleAccountsRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryModuleAccountByNameRequest({ value }: queryModuleAccountByNameRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryModuleAccountByNameRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    addressBytesToStringRequest({ value }: addressBytesToStringRequestParams): EncodeObject {
      try {
        return {
          ...
          value: AddressBytesToStringRequest.fromPartial(value),
        };
      } catch (e: any) {

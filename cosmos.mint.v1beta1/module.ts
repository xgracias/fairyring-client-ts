...
export const txClient = (
  ...
  return {
    ...
    async sendQueryAnnualProvisionsRequest({
      value,
      fee,
      memo,
    }: sendQueryAnnualProvisionsRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryInflationResponse({
      value,
      fee,
      memo,
    }: sendQueryInflationResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAnnualProvisionsResponse({
      value,
      fee,
      memo,
    }: sendQueryAnnualProvisionsResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    queryInflationRequest({ value }: queryInflationRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryInflationRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAnnualProvisionsRequest({ value }: queryAnnualProvisionsRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAnnualProvisionsRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryInflationResponse({ value }: queryInflationResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryInflationResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAnnualProvisionsResponse({ value }: queryAnnualProvisionsResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAnnualProvisionsResponse.fromPartial(value),
        };
      } catch (e: any) {

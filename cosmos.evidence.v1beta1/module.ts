...
export const txClient = (
  ...
  return {
    ...
    async sendQueryAllEvidenceResponse({
      value,
      fee,
      memo,
    }: sendQueryAllEvidenceResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgSubmitEvidenceResponse({
      value,
      fee,
      memo,
    }: sendMsgSubmitEvidenceResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendQueryAllEvidenceRequest({
      value,
      fee,
      memo,
    }: sendQueryAllEvidenceRequestParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    queryEvidenceResponse({ value }: queryEvidenceResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryEvidenceResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAllEvidenceResponse({ value }: queryAllEvidenceResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAllEvidenceResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    msgSubmitEvidenceResponse({ value }: msgSubmitEvidenceResponseParams): EncodeObject {
      try {
        return {
          ...
          value: MsgSubmitEvidenceResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryEvidenceRequest({ value }: queryEvidenceRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryEvidenceRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    queryAllEvidenceRequest({ value }: queryAllEvidenceRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QueryAllEvidenceRequest.fromPartial(value),
        };
      } catch (e: any) {

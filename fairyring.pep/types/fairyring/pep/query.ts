...
export const QueryAllEncryptedTxFromHeightRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryAllEncryptedTxFromHeightRequest>, I>,
  >(object: I): QueryAllEncryptedTxFromHeightRequest {
    const message = createBaseQueryAllEncryptedTxFromHeightRequest();
    message.targetHeight = object.targetHeight ?? 0;
    return message;
  },
...
export const QueryAllEncryptedTxFromHeightResponse = {
  ...
  toJSON(message: QueryAllEncryptedTxFromHeightResponse): unknown {
    const obj: any = {};
    message.encryptedTxArray !== undefined &&
      (obj.encryptedTxArray = message.encryptedTxArray
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryAllEncryptedTxFromHeightResponse>, I>,
  >(object: I): QueryAllEncryptedTxFromHeightResponse {
    const message = createBaseQueryAllEncryptedTxFromHeightResponse();
    message.encryptedTxArray =
...
export const QueryLatestHeightRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryLatestHeightRequest>, I>>(
    _: I
  ): QueryLatestHeightRequest {
    const message = createBaseQueryLatestHeightRequest();
    return message;
...
export const QueryGetPepNonceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetPepNonceRequest>, I>>(
    object: I
  ): QueryGetPepNonceRequest {
    const message = createBaseQueryGetPepNonceRequest();
...
export const QueryGetPepNonceResponse = {
  ...
  fromJSON(object: any): QueryGetPepNonceResponse {
    return {
      pepNonce: isSet(object.pepNonce)
        ? PepNonce.fromJSON(object.pepNonce)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryGetPepNonceResponse): unknown {
    const obj: any = {};
    message.pepNonce !== undefined &&
      (obj.pepNonce = message.pepNonce
        ? PepNonce.toJSON(message.pepNonce)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryGetPepNonceResponse>, I>>(
    object: I
  ): QueryGetPepNonceResponse {
    const message = createBaseQueryGetPepNonceResponse();
    message.pepNonce =
      object.pepNonce !== undefined && object.pepNonce !== null
...
export const QueryAllPepNonceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllPepNonceRequest>, I>>(
    object: I
  ): QueryAllPepNonceRequest {
    const message = createBaseQueryAllPepNonceRequest();
    message.pagination =
...
export const QueryAllPepNonceResponse = {
  ...
  fromJSON(object: any): QueryAllPepNonceResponse {
    return {
      pepNonce: Array.isArray(object?.pepNonce)
        ? object.pepNonce.map((e: any) => PepNonce.fromJSON(e))
        : [],
      pagination: isSet(object.pagination)
        ? PageResponse.fromJSON(object.pagination)
        : undefined,
  ...
  toJSON(message: QueryAllPepNonceResponse): unknown {
    const obj: any = {};
    if (message.pepNonce) {
      obj.pepNonce = message.pepNonce.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllPepNonceResponse>, I>>(
    object: I
  ): QueryAllPepNonceResponse {
    const message = createBaseQueryAllPepNonceResponse();
    message.pepNonce =
      object.pepNonce?.map((e) => PepNonce.fromPartial(e)) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
        ? PageResponse.fromPartial(object.pagination)
        : undefined;
...
export interface Query {
  ...
  LatestHeight(
    request: QueryLatestHeightRequest
  ): Promise<QueryLatestHeightResponse>;
  ...
  PepNonceAll(
    request: QueryAllPepNonceRequest
  ): Promise<QueryAllPepNonceResponse>;
...
export class QueryClientImpl implements Query {
  ...
  EncryptedTx(
    ...
    return promise.then((data) =>
      QueryGetEncryptedTxResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  EncryptedTxAll(
    ...
    return promise.then((data) =>
      QueryAllEncryptedTxResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  EncryptedTxAllFromHeight(
    ...
    return promise.then((data) =>
      QueryAllEncryptedTxFromHeightResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  LatestHeight(
    ...
    return promise.then((data) =>
      QueryLatestHeightResponse.decode(new _m0.Reader(data))
    );
  }

  PepNonce(
    request: QueryGetPepNonceRequest
  ): Promise<QueryGetPepNonceResponse> {
    const data = QueryGetPepNonceRequest.encode(request).finish();
    const promise = this.rpc.request('fairyring.pep.Query', 'PepNonce', data);
    return promise.then((data) =>
      QueryGetPepNonceResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  PepNonceAll(
    ...
    return promise.then((data) =>
      QueryAllPepNonceResponse.decode(new _m0.Reader(data))
    );
  }

...
export const PepPacketData = {
  ...
  fromPartial<I extends Exact<DeepPartial<PepPacketData>, I>>(
    object: I
  ): PepPacketData {
    const message = createBasePepPacketData();
    message.noData =
...
export const CurrentKeysPacketAck = {
  ...
  toJSON(message: CurrentKeysPacketAck): unknown {
    ...
    message.activeKey !== undefined &&
      (obj.activeKey = message.activeKey
        ? ActivePubKey.toJSON(message.activeKey)
        : undefined);
    message.queuedKey !== undefined &&
      (obj.queuedKey = message.queuedKey
        ? QueuedPubKey.toJSON(message.queuedKey)
        : undefined);
    return obj;
  },

...
export { UnbondingDelegationEntry, MsgEditValidatorResponse, MsgDelegate, MsgUndelegate, ValAddresses, UnbondingDelegation, RedelegationEntry, QueryValidatorRequest, QueryValidatorUnbondingDelegationsRequest, QueryHistoricalInfoResponse, LastValidatorPower, Commission, Redelegation, MsgCreateValidatorResponse, QueryDelegationRequest, QueryPoolRequest, CommissionRates, QueryDelegatorDelegationsResponse, StakeAuthorization, QueryValidatorDelegationsRequest, DVVTriplets, QueryValidatorsResponse, QueryValidatorUnbondingDelegationsResponse, QueryDelegatorDelegationsRequest, GenesisState, Validator, QueryDelegatorUnbondingDelegationsResponse, MsgEditValidator, MsgUpdateParams, MsgUpdateParamsResponse, QueryValidatorDelegationsResponse, QueryRedelegationsResponse, QueryDelegatorValidatorsResponse, DVPairs, MsgCreateValidator, StakeAuthorization_Validators, MsgBeginRedelegateResponse, QueryDelegatorValidatorRequest, QueryParamsResponse, RedelegationEntryResponse, MsgDelegateResponse, QueryValidatorResponse, QueryUnbondingDelegationRequest, DVVTriplet, MsgCancelUnbondingDelegationResponse, QueryDelegatorValidatorsRequest, QueryDelegatorValidatorResponse, QueryPoolResponse, HistoricalInfo, ValidatorUpdates, QueryUnbondingDelegationResponse, Delegation, Params, Pool, MsgCancelUnbondingDelegation, QueryParamsRequest, Description, DVPair, QueryValidatorsRequest, QueryRedelegationsRequest, QueryHistoricalInfoRequest, MsgUndelegateResponse, MsgBeginRedelegate, QueryDelegationResponse, QueryDelegatorUnbondingDelegationsRequest, DelegationResponse, RedelegationResponse };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		delegation({ value }: delegationParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.staking.v1beta1.Msg/Delegate", value: Delegation.fromPartial( value ) }  
			} catch (e: any) {
		...
		delegationResponse({ value }: delegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.staking.v1beta1.Msg/DelegateResponse", value: DelegationResponse.fromPartial( value ) }  
			} catch (e: any) {

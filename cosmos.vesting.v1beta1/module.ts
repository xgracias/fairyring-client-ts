...
export const txClient = (
  ...
  return {
    ...
    async sendPeriodicVestingAccount({
      value,
      fee,
      memo,
    }: sendPeriodicVestingAccountParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgCreatePermanentLockedAccountResponse({
      value,
      fee,
      memo,
    }: sendMsgCreatePermanentLockedAccountResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgCreatePermanentLockedAccountResponse: Unable to sign Tx. Signer is not present.'
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry });
        let msg = this.msgCreatePermanentLockedAccountResponse({
          value: MsgCreatePermanentLockedAccountResponse.fromPartial(value),
        });
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
      } catch (e: any) {
    ...
    async sendMsgCreatePeriodicVestingAccountResponse({
      value,
      fee,
      memo,
    }: sendMsgCreatePeriodicVestingAccountResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          'TxClient:sendMsgCreatePeriodicVestingAccountResponse: Unable to sign Tx. Signer is not present.'
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry });
        let msg = this.msgCreatePeriodicVestingAccountResponse({
          value: MsgCreatePeriodicVestingAccountResponse.fromPartial(value),
        });
        return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
      } catch (e: any) {
    ...
    async sendPermanentLockedAccount({
      value,
      fee,
      memo,
    }: sendPermanentLockedAccountParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendMsgCreateVestingAccountResponse({
      value,
      fee,
      memo,
    }: sendMsgCreateVestingAccountResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendContinuousVestingAccount({
      value,
      fee,
      memo,
    }: sendContinuousVestingAccountParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    periodicVestingAccount({ value }: periodicVestingAccountParams): EncodeObject {
      try {
        return {
          ...
          value: PeriodicVestingAccount.fromPartial(value),
        };
      } catch (e: any) {
    ...
    delayedVestingAccount({ value }: delayedVestingAccountParams): EncodeObject {
      try {
        return {
          ...
          value: DelayedVestingAccount.fromPartial(value),
        };
      } catch (e: any) {
    ...
    permanentLockedAccount({ value }: permanentLockedAccountParams): EncodeObject {
      try {
        return {
          ...
          value: PermanentLockedAccount.fromPartial(value),
        };
      } catch (e: any) {
    ...
    msgCreateVestingAccountResponse({ value }: msgCreateVestingAccountResponseParams): EncodeObject {
      try {
        return {
          ...
          value: MsgCreateVestingAccountResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    continuousVestingAccount({ value }: continuousVestingAccountParams): EncodeObject {
      try {
        return {
          ...
          value: ContinuousVestingAccount.fromPartial(value),
        };
      } catch (e: any) {

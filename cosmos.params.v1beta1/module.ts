...
export const txClient = (
  ...
  return {
    ...
    async sendQuerySubspacesResponse({
      value,
      fee,
      memo,
    }: sendQuerySubspacesResponseParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    async sendParameterChangeProposal({
      value,
      fee,
      memo,
    }: sendParameterChangeProposalParams): Promise<DeliverTxResponse> {
      if (!signer) {
    ...
    querySubspacesRequest({ value }: querySubspacesRequestParams): EncodeObject {
      try {
        return {
          ...
          value: QuerySubspacesRequest.fromPartial(value),
        };
      } catch (e: any) {
    ...
    querySubspacesResponse({ value }: querySubspacesResponseParams): EncodeObject {
      try {
        return {
          ...
          value: QuerySubspacesResponse.fromPartial(value),
        };
      } catch (e: any) {
    ...
    parameterChangeProposal({ value }: parameterChangeProposalParams): EncodeObject {
      try {
        return {
          ...
          value: ParameterChangeProposal.fromPartial(value),
        };
      } catch (e: any) {
